...
This was created as a submission for the [Open Data Challenge for Public Transport 2024](https://challenge2024.odpt.org/index-e.html), a competition for open-data based applications.
...
Our first component is the [Journey Planner / Isopleth](https://nishikata-tokotoko.github.io/cycle-shortcut-map/map.html) that allows travel between stations if that is an acceptable choice.
